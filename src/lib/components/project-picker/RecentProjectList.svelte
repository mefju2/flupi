  ...
  <ul class="space-y-1">
    {#each projects as p}
      <li class="relative group">
        ...
        {#if onRemove}
          <button
            class="absolute right-2 top-1/2 -translate-y-1/2 p-1 rounded text-app-text-4 opacity-0 group-hover:opacity-100 hover:text-app-text hover:bg-app-hover transition-all duration-150"
